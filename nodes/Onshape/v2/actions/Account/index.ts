		...
		options: [
			{
				...
				description: 'get /accounts/plans/{planId}/purchases',
			},
			{
				name: 'getPurchases',
			...
			},
			{
				...
				description: 'Mark purchase consumed by the user by purchase ID. - post /accounts/purchases/{pid}/consume',
			},
			{
				name: 'cancelPurchaseNew',
				value: 'DELETE /accounts/{aid}/purchases/{pid}',
				description: 'Cancel recurring subscription for the account by account ID and purchase ID. - delete /accounts/{aid}/purchases/{pid}',
			},
		],
