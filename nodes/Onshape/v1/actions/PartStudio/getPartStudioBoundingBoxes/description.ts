...
export const getPartStudioBoundingBoxesDescription: INodeProperties[] = [
	{
		...
		options: [
			{
				...
				values: [
					...
					{
						name: 'includeWireBodies-boolean(query)',
						displayName: 'includeWireBodies',
						description: 'includeWireBodies - boolean (query)',
						type: 'boolean',
						default: true,
					},
					{
