...
import { versionDescription } from './actions/versionAppElementDescription';
// import { loadOptions } from './methods';
import { parseParameters } from '../generateRequest';

export class OnshapeAppElementV3 implements INodeType {
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const isJson =
			!(operation === 'GET /appelements/d/{did}/{vm}/{vmid}/e/{eid}/blob/{bid}') &&
			!(operation === 'GET /appelements/d/{did}/w/{wid}/e/{eid}/blob/{bid}')
