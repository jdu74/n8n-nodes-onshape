...
export const ExportParasolidDescription: INodeProperties[] = [
	{
		displayName: 'did',
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						name: 'includeExportIds-boolean(query)',
						description: 'includeExportIds - boolean (query)',
						type: 'boolean',
						default: false,
					},
					{
					...
					{
						displayName: 'binaryExport',
						name: 'binaryExport-boolean(query)',
						description: 'binaryExport - boolean (query)',
						type: 'boolean',
						default: false,
					},
				],
